...
class PagSeguro_PaymentMethod{
    ...
    */
    ...
    public function setType($type) {
    	if ($type instanceof PagSeguro_PaymentMethodType) {
    		$this->type = $type;
    	} else {
    		$this->type = new PagSeguro_PaymentMethodType($type);
    	}
    }
    ...
    public function setCode($code) {
        if ($code instanceof PagSeguro_PaymentMethodCode) {
    		$this->code = $code;
    	} else {
    		$this->code = new PagSeguro_PaymentMethodCode($code);
    	}
    }
