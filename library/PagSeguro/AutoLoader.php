...
class PagSeguro_Autoloader {
	...
	public static function init() {
		...
		if (self::$loader == null) {
			self::$loader = new PagSeguro_Autoloader();
		}
		return self::$loader;
	}
	...
	private function addClass($class) {
		foreach(self::$dirs as $key => $dir) {
			$file = PagSeguro_Library::getPath().DIRECTORY_SEPARATOR.$dir.DIRECTORY_SEPARATOR.$class.'.class.php';
