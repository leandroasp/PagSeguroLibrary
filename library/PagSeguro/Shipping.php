...
class PagSeguro_Shipping {
    ...
    */
	...
	public function __constuct(Array $data = null) {
		if ($data) {
			if (isset($data['address']) && $data['address'] instanceof PagSeguro_Address) {
				$this->address = $data['address'];
			}
			if (isset($data['type']) && $data['type'] instanceof PagSeguro_ShippingType) {
				$this->type = $data['type'];
			}
			if (isset($data['cost'])) {
				$this->cost = $data['cost'];
	 ...
	 */
    public function setAddress(PagSeguro_Address $address) {
     ...
     * @see PagSeguroShippingType
     */
    public function setType(PagSeguro_ShippingType $type) {
        $this->type = $type;
    }
