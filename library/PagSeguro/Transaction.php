...
class PagSeguro_Transaction {
     ...
     */
    public function setType(PagSeguro_TransactionType $type) {
        $this->type = $type;
    }
     ...
     */
    public function setStatus(PagSeguro_TransactionStatus $status) {
        $this->status = $status;
    }
     ...
     */
    public function setPaymentMethod(PagSeguro_PaymentMethod $paymentMethod) {
     ...
     */
    public function setSender(PagSeguro_Sender $sender) {
        $this->sender = $sender;
    }
     ...
     */
    public function setShipping(PagSeguro_Shipping $shipping) {
