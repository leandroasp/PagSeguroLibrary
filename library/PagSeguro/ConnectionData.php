...
class PagSeguro_ConnectionData{
	...
	public function __construct(PagSeguro_Credentials $credentials, $serviceName) {
	
		$this->credentials = $credentials;
		$this->serviceName = $serviceName;
	
		$this->setEnvironment(PagSeguro_Config::getEnvironment());
		$this->setWebserviceUrl(PagSeguro_Resources::getWebserviceUrl($this->getEnvironment()));
		$this->setCharset(PagSeguro_Config::getApplicationCharset());
	
		$this->resources = PagSeguro_Resources::getData($this->serviceName);
	...
	public function setCredentials(PagSeguro_Credentials $credentials) {
		$this->credentials = $credentials;
	}
